program LU_Pivot_LeastSquareMethod
implicit none
real(8)::t(21),h(21),A(4,4),b(4),saveA(4,4),saveb(4),x(4),y(4)
...
call showmat(A,4)
print*, 'Find the coefficients of ax^3+bx^2
+cx+d. The result is:'
call backward(A,b,4)
print*,'a=', b(1),'b=',b(2),'c=',b(3), 'd=', b(4)
call checksol(saveA,b,saveb,4)
end program LU_Pivot_LeastSquareMethod
